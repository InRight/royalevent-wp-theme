...
<div id="page" class="site">
	 ...
	 */
	if ( ( is_single() || ( is_page() && ! royalevent_is_frontpage() ) ) && has_post_thumbnail( get_queried_object_id() ) ) :
		echo '<div class="single-featured-image-header">';
		echo get_the_post_thumbnail( get_queried_object_id(), 'royalevent-featured-image' );

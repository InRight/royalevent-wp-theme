 ...
 */
function royalevent_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Royal Event default saturation level.
	 *
	 * @since Royal Event 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'royalevent_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.royalevent-front-page) .entry-title,
...
.colors-custom .royalevent-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.royalevent-front-page .panel-content .recent-posts article,
...
.colors-custom.royalevent-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Royal Event custom colors CSS.
	 *
	 * @since Royal Event 1.0
	 *
	 ...
	 */
	return apply_filters( 'royalevent_custom_colors_css', $css, $hue, $saturation );
}
